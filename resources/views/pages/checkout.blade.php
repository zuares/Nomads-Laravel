                    ...
                    <div class="card card-details ">
                            ...
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{route('checkout-remove', $detail->id)}}">X</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST" action="{{route('checkout-create', $item->id)}}">
                                ...
                                <input style="width:50px" type="text" class="form-control mb-2 mr-sm-2" id="nationality"
                                    placeholder="nationality" name="nationality" required>

                                <label for="is_visa" class="sr-only">VISA</label>
                                <select name="is_visa" class="form-control custom-select mb-2 mr-sm-2" id="is_visa"
                                    required>
                                    <option name="is_visa" value="VISA" selected>VISA</option>
                                    <option name="is_visa" value="1">30 Days</option>
                                    <option name="is_visa" value="0">N/A</option>
                                </select>

                                <label for="doe_passport" class="sr-only">DOE Passport</label>
                                <div class="input-group mb-2 mb-2 mr-sm-2">
                                    <input type="text" class="form-control datepicker" id="doe_passport"
                                        placeholder="DOE Passport" name="doe_passport" required>
                                </div>
